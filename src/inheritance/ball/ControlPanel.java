...
public class ControlPanel extends JPanel implements ActionListener, MouseListener, KeyListener{
    ...
    public void keyPressed(KeyEvent event){
        ...
        //TODO: This is an Example of a switch expression
        switch (keyPress){
            case KeyEvent.VK_UP     -> up();
            case KeyEvent.VK_DOWN   -> down();
            case KeyEvent.VK_LEFT   -> left();
            case KeyEvent.VK_RIGHT  -> right();
            case KeyEvent.VK_TAB    -> increase();
            case KeyEvent.VK_SHIFT  -> decrease();
            case KeyEvent.VK_SPACE  -> plane();
        }
